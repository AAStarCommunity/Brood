...
2. **装 Hyphae**：HyperCapital 一对一辅导，30-60 分钟
...
| 6 | **HyperCapital 辅导服务** | 中 | 与 FangPay / Loyalty 共享商业服务实体 |
...
| 3 | **预训练 / 微调** | \$0.5-40/M token | ✅ 一次性辅导 \$499-5k | **当下主力** |
| 4 | **部署服务** | enterprise tier | ✅ HyperCapital 包 A/B/C | **当下主力** |
| 5 | **溢出 API** | n/a | ✅ 比 Firework 便宜 30-50\% | 当下补充 |
| 6 | **协作网络服务费**（远期）| n/a | ⭐⭐ **中小组织 Hyphae 间互联** | **远期愿景** |

**当下定位**：本地 token 免费、把训练 + 部署变成"服务而非云"；少了 Firework 的 token 大头收入，但替换为**一次性服务费 + 月度运维 + 溢出 API 补充**。
...
- **Y1 行业模板奠基**：创始人亲自带 20 种子客户 onboarding；沉淀医疗 / 律所 / 制造 / 教育 / 贸易 5 个行业模板；与 Mycelium 生态联动招募
- **Y2 HyperCapital 渠道复制**：训练 5-10 个工程师做 onboarding；行业模板扩到 10+；进入中国 / 东南亚 / 中东（数据主权强需求市场）
- **Y3 开源社区 + 协作网络**：开源贡献者 100+；与 ERP / CRM / OA 服务商合作；50+ 渠道伙伴；协作网络试运行
...
| **HyperCapital 工程师** | 1-2 FTE，与 FangPay / Loyalty 共享 |
...
| **Q1 2027** | HyperCapital 服务包 A/B 标准化；20 客户；ARR \$90k |
| **Q2 2027** | 中国 / 东南亚 / 中东首批客户；50 客户；ARR \$250k |

## 5.4 风险 · Ask

**风险与应对**：Firework 下沉 → 业务 know-how + 本地化筑墙 ／ 中小组织付费意愿低 → 本地 token 免费降低门槛 + 后端 / 协作网络变现 ／ 数据 / 监管 → 完全本地 + 开源可审计 + 律师函（协议层共享）。

**Ask**：资金 \$\_\_\_（Pre-seed，金额待填）·  用途 50\% 工程 / 30\% HyperCapital / 15\% GTM / 5\% 法务  ·  期限 18 个月跑到 50 客户 + ARR \$250k 支撑 Series A  ·  联系 **jhfnetboy@gmail.com**

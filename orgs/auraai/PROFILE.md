...
provides:
  - capability: ai-agent-framework
    ...
    repo: github.com/iDoris-ai/Agent24
  ...
  - capability: ai-education
    ...
    repo: github.com/iDoris-ai/courses
depends_on:
  - org: aastar
...
iDoris.ai 是 Mycelium Protocol 生态中的 **AI 能力层**，专注于构建面向社区和个人的 AI 代理基础设施。
...
核心里程碑（见 BroodBrain TASK-34 iDoris.ai 任务看板）：
